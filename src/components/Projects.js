...
export const Projects = () => {
  ...
  const projects = [
    {
      title: "MineForge: Managerial Challenge",
      description: "Are you ready to step into the shoes of a future mine manager and confront the complexities of the mining industry head-on? Join us at MINARE 2024 for an immersive simulation challenge designed specifically for aspiring mine managers. Mine Manager Simulation Challenge offers aspiring mine managers an immersive opportunity to navigate the complexities of the mining industry through simulated scenarios. Participants will engage in realistic exercises including mining planning and development simulations, production optimization challenges, DGMS inspection drills, and accidental scenario exercises, honing their decision-making, problem-solving, and crisis management skills. This event provides hands-on learning, industry insights,and networking opportunities, empowering future mine managers to prepare for leadership roles in the evolving mining sector.",
      imgUrl: projImg1,
    },
    {
